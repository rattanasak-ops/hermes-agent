...
NEW_CHAT_INSTALLER="$SCRIPT_DIR/../scripts/new-chat/install-local.sh"
...
if [ ! -f "$NEW_CHAT_INSTALLER" ]; then
  say "ผิดพลาด: ไม่พบตัวติดตั้ง New Chat Gate ที่ $NEW_CHAT_INSTALLER"
  exit 1
fi
...
say "      สำเร็จ: Hook ภาษาคน/ผู้ตรวจอิสระ/หลักฐาน/New Chat Gate พร้อมตรวจ"
