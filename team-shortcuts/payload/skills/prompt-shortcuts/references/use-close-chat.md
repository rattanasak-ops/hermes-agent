...
- ถ้าเป้าหมายที่เจ้าของสั่งยังมีเฟส merge เข้า main, VPS, เครื่องทีม หรือแผนกลางที่ยังไม่เสร็จและยังทำต่อได้ ห้ามเข้า CLOSE และห้ามเขียนไฟล์ปิดงานลงชุดส่งโค้ด ให้ทำเฟสนั้นต่อก่อน
