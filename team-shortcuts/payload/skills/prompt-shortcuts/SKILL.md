...
- `SYSTEM_REGISTERED_BRANCH_RECOVERY`: ถ้า Git root ตรงงานแต่หลุด detached HEAD/กิ่งร่วม ให้ AI รัน `hermes-current-workspace-recover --cwd <Git root> --json` เพื่อกู้กิ่งตามสมุดทะเบียนในพื้นที่เดิม ห้ามสร้าง Worktree ห้ามเดาชื่อกิ่ง และห้ามผลักให้ผู้ใช้เปิดพื้นที่/กิ่งเอง
