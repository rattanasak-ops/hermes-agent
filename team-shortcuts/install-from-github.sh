...
say ""
say "คำสั่งติดตั้งจาก GitHub สำหรับเครื่องอื่น:"
say "  Mac · Codex App: curl -fsSL https://raw.githubusercontent.com/rattanasak-ops/hermes-agent/main/team-shortcuts/install-from-github.sh | bash"
say "  Mac · Cursor + Codex App: curl -fsSL https://raw.githubusercontent.com/rattanasak-ops/hermes-agent/main/team-shortcuts/install-from-github.sh | bash -s -- --cursor"
say "  Windows · Cursor + Codex App: irm https://raw.githubusercontent.com/rattanasak-ops/hermes-agent/main/team-shortcuts/install-from-github.ps1 | iex"
say "  หมายเหตุ: MW บน Windows ยังต้องใช้ WSL หรือ Git Bash และยังไม่ยืนยันการรองรับผ่าน PowerShell โดยตรง"
