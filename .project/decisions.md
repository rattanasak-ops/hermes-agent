...
## DEC-SHORTCUT-001 · พื้นที่ปัจจุบัน + ทำงานต่อเป็นเฟส (2026-07-19)

- Shortcut ทุกตัวใช้ Git root/กิ่งที่แอปเปิดอยู่ และไม่มีสิทธิ์สร้างหรือสลับ Worktree/กิ่งเอง
- detached HEAD กู้ได้เฉพาะชื่อกิ่งในสมุดทะเบียนที่ตรง Git root และ SHA เดิม; กรณีอื่นคืนรหัสจากเครื่องโดยไม่ผลักให้เจ้าของเปิดพื้นที่ใหม่
- เมื่อเจ้าของอนุมัติเป้าหมายหรือเฟสแล้ว งานปลอดภัยมีงบคำถาม 0 ครั้งจนถึงด่านปิดเฟส; คำถามแทรกไม่ยกเลิกงานเดิม
- การหยุดรอเจ้าของต้องใช้ `OWNER_INPUT_REQUIRED` พร้อมรหัสเหตุผลและหลักฐานจากเครื่อง และห้ามถามซ้ำจนกว่าสถานะเปลี่ยน
- รุ่นนำร่อง `2026.07.19-2` ผ่านบน Mac แล้ว; main/VPS/เครื่องทีมยังเป็นงานส่งต่อ ห้ามอ้างว่ากระจายครบก่อนตรวจจริง
