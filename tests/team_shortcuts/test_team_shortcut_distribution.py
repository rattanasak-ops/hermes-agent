...
def test_distribution_has_traceable_version_and_required_runtime_tools():
    ...
    assert "plugins.entries.agent-center.llm.allow_provider_override true" in installer
    assert "plugins.entries.agent-center.llm.allow_model_override true" in installer
